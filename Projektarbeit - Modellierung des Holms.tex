...
\end{equation}
\begin{equation}
EI_{x}\cdot w_{III}(y) = \frac{q_{III}(y)}{24}\cdot y^{4} + \frac{R_{9}}{6}\cdot y^{10} + \frac{R_{3}}{2}\cdot y^{2} + R_{11}\cdot y + R_{12}
\end{equation}\\
...
\begin{equation}
	Q(y,F_{pruef},F_{Q},EI_{x})=\left\{\begin{array}{ll}
		...
		F_{pruef}+F_{Q}&,y\epsilon (l_{1}+l{2})\\
		F_{pruef}&,y\epsilon (l_{1}+l{2}+l{3})
	\end{array}\right.
\end{equation}\\
\begin{equation}
	M(y,F_{pruef},F_{Q},EI_{x})=\left\{\begin{array}{ll}
		...
		(F_{pruef}+F_{Q})\cdot y - F_{pruef}\cdot (l_{1}+l_{2}+l_{3})-F_{Q}\cdot (l_{1}+L_{2})&,y\epsilon (l_{1}+l{2})\\
		F_{pruef}\cdot y - F_{pruef}\cdot (l_{1}+l_{2}+l_{3})&,y\epsilon (l_{1}+l{2}+l{3})
	\end{array}\right.
\end{equation}\\
\begin{equation}
...
In Abb. ~\ref{fig:Steifigkeitsauslegung} werden der Querkraftverlauf $Q(y,F_{pruef},F_{Q},EI_{x})$ (als innere Schnittkraft), der Momentverlauf $M(y,F_{pruef},F_{Q},EI_{x})$ (als inneres Schnittmoment) und die Biegelinie $w(y,F_{pruef},F_{Q},EI_{x})$,für den Nachweis der Steifigkeit graphisch dargestellt, über die gesamte Holmlänge und einem vergrößerten Ausschnitt im Bereich der Lager. \\
