\subsection{Berechnung: Analytische Lösung der Modellierung (T.B.)}\label{Lösung}
...
\end{itemize}
\newpage
\subsection{Berechnung: Schubfluss und Schubmittelpunkt (O.S.)}\label{SchubRechnung}
\begin{itemize}
...
\end{itemize}
\newpage
\subsection{Abbildungen: $eLamX^{2}$}\label{Abbildungen}
\begin{figure}[h]
...
\FloatBarrier
\newpage
\subsection{Abbildungen: Beulberechnung}
\begin{figure}[h]
	\centering
...
\FloatBarrier
\newpage
\subsection{Abbildungen Schubfluss}
\begin{figure}[h]
	\centering
...
\newpage
\newpage
\subsection{Abbildungen: Konstruktion und Fertigung}
\begin{figure}[h]
