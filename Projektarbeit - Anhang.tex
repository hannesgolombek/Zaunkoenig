\subsection{Berechnung: Analytische Lösung der Modellierung}\label{Lösung}
...
\end{itemize}
\newpage
\subsection{Berechnung: Schubfluss und Schubmittelpunkt}\label{SchubRechnung}
\begin{itemize}
...
\begin{figure}[h]
	\includegraphics[angle=90, scale=0.9]{PDFs/Explosionsdarstellung.pdf}
	\centering
\end{figure}
\begin{figure}[h]
	\includegraphics[angle=90, scale=0.9]{PDFs/Profilkontur.pdf}
	\centering
\end{figure}
\begin{figure}[h]
	\includegraphics[angle=90, scale=0.9]{PDFs/KlotzVorne.pdf}
	\centering
\end{figure}
\begin{figure}[h]
	\includegraphics[angle=90, scale=0.9]{PDFs/Holmquerschnitte.pdf}
	\centering
\end{figure}