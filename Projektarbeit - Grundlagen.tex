...
Das Prinzip der klassischen Laminattheorie ist die Beschreibung des Elastizitätsgesetzes eines MSV durch die Elastizitätsgesetze der einzelnen Schichten. Dies lässt sich durch die Annahme eines ideal elastischem und fehlerfrei verklebten MSV, wovon ein infinitesimales Scheibenelement betrachtet wird, realisieren. Zusätzlich gilt die Annahme, dass ein ebener Spannungszustand vorliegt, die Schnittspannungen über die Dicke konstant sind und keine Verwölbungen auftreten.\\
\noindent
...
\end{equation}
Nun lässt sich nun das Elastizitätsgesetz für den MSV aufstellen.
\begin{equation}
\label{Aep}
...
\end{Bmatrix}
\end{gather}
Die Verzerrung des MSV und somit auch die Verzerrung der Einzelschichten, lässt sich nun durch die Umstelung von Gleichung \ref{Aep} bestimmen.
\begin{equation}
...
Für den einachsigen Spannungszustand lassen sich die Module und Querkontraktionszahlen für den MSV ableiten.
...
\end{equation}
\noindent
Bei den Elastizitätsmodule ist darauf zu achten, dass es sich um Module ohne Querkontraktionsbehinderung handelt.\cite{item3}
...
Um die Materialkonstanten des FKV zu ermitteln kann die Mischungsregel verwendet werden. Darin werden die Mateialkonstanten der Fasern und der Matrix im Verhältnis zu ihrem Massenanteil zu einer FKV-Materialkonstante zusammengestellt.\\
\noindent
