...
\begin{figure}[h]
 ...
 \caption{Vereinfachtes Modell für Schubflussberechnung}
 \label{Fluegel1}
\end{figure}
...
\noindent Nun werden die Flächenträgheitsmomente nach Gleichungen \ref{FT1}-\ref{FT3} zuerst aus ihrem eigenen Schwerpunkt errechnet, sodass die auf den Gesamtschwerpunkt bezogenen Flächenträgheitsmomente $I_{\bar{y}}$, $I_{\bar{z}}$ und $I_{\bar{y}\bar{z}}$ mit Hilfe des Steinerschen Satzes
 \begin{equation}
 	I_{\bar{y}} = I_{y} + z^2A
 \end{equation}
\begin{equation}
...
\begin{figure}[h]
	...
	\caption{Angreifende Kraft und positive Drehrichtung am geschlossenen Profil}
\end{figure}
