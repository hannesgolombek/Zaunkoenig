...
Da die Holzklötze ebenfalls eine komplizierte Geometrie aufweisen, wird auch ihre Masse der Einfachheit halber mit dem CAD-Programm berechnet. Als Material wird Kiefernholz gewählt,das mit $ \rho_{Kiefer}=559\frac{kg}{m^{3}} $ im mittleren Bereich der Dichten im CAD-Programm verfügbarer Hölzer liegt. Die Masse eines jeden Holzklotzes wird damit zu $ m_{Klotz}=0,015kg $ bestimmt.
